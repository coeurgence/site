...
// ==========================================================
// v8: horizontal logo strip
// ==========================================================

const logoStrip =
  document.querySelector(".logo-constellation") ||
  document.querySelector(".logo-grid");

if (logoStrip) {
  logoStrip.addEventListener("wheel", event => {
    if (Math.abs(event.deltaY) > Math.abs(event.deltaX)) {
      event.preventDefault();
      logoStrip.scrollLeft += event.deltaY;
    }
  }, { passive: false });
}
